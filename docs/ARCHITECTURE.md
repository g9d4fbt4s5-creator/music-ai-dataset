...
> 版本: v1.1.0 | 更新: 2026-08-26 | 状态: 历史参考（已被 V4 取代）
>
> ⚠️ **重要更新（2026-08-28）**：流水线架构已修订至 V4，补充了采集入库、语言过滤、歌词转写、DBSCAN聚类、HITL人工在环，并修正了 L4 KNN 防泄漏规则。
> 最新权威流程文档：[PIPELINE_OVERVIEW_V4.md](./PIPELINE_OVERVIEW_V4.md)
> 本文档的 Stage 编号为历史设计，实际代码以 V4 文档为准。
