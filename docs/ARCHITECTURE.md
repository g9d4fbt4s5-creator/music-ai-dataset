...
> 版本: v1.1.0 | 更新: 2026-08-26 | 状态: 生产级可落地
>
> ⚠️ **重要更新（2026-08-26）**：流水线架构已修正，切片从 Stage 1/6 移到 **Stage 5（数据划分之后）**。
> 最新权威流程文档：[PIPELINE_OVERVIEW_V2.md](./PIPELINE_OVERVIEW_V2.md)
> 本文档的 Stage 编号为历史设计，实际代码以 V2 文档为准。
